 ...
 * var sliceGeometry = new VJS.geometry.slice(halfDimensions, center, orientation, position, direction);
 ...
 *  scene.add(slice);
 */
VJS.geometry.slice = function(halfDimensions, center, orientation, position, direction) {
...
VJS.geometry.slice.prototype = Object.create(THREE.ShapeGeometry.prototype);
VJS.geometry.slice.prototype.constructor = VJS.geometry.slice;
 ...
 */
VJS.geometry.slice.prototype.centerOfMass = function(points) {
 ...
 */
VJS.geometry.slice.prototype.orderIntersections = function(points, reference, direction) {
    var a0 = points[0].x;
    var b0 = points[0].y;
    var c0 = points[0].z;
