...
VJS.parsers.dicom.prototype.parse = function(){
  // var image = ... VJS.parsers.dicom(arrayBuffer);
  // some post-processing if we want?

  window.console.log(this._arrayBuffer);

  var imageNameFS = 'image_' + this._id;
  window.console.log(imageNameFS);

  //
  // write to virtual FS
  //
  var uploadedObject = new Int8Array(this._arrayBuffer);
  ...
  // Dom to image it!
  return this.domToImage($dicomDom, frameNameFS);
};
